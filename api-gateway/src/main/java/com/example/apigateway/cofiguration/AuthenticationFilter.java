...
public class AuthenticationFilter implements GlobalFilter, Ordered {
    ...
    final String[] publicEndPoint = {
            ...
            "/order-service/websocket/ws",
            "/order-service/address/**",
            "/voucher-service/getAll",
            "/review-service/review/list-review-of-product/*",
    };
    ...
    boolean ispublicEndPoint(ServerHttpRequest request) {
        ...
        return Arrays.stream(publicEndPoint)
                .anyMatch(endpoint -> pathMatcher.match(apiPrefix + endpoint, requestPath));
    }
